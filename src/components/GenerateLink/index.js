...
function GenerateLink() {
  ...
  const URL = `https://jaliliin.herokuapp.com/?to=${encodeURIComponent(name)}`;
            ...
            <table class="table">
              ...
              <tbody>
                {data.map((d, index) => {
                  ...
                  const mapURL = `https://jaliliin.herokuapp.com/?to=${encodeURIComponent(d.name)}${offlineInvitation}`;
                  return (
                    <tr>
                      <td>{index + 1}</td>
                      <td>{d.name}</td>
  ...
  return (
    <div>
      ...
      <h3 className="title__sub">Iin & Jalil Wedding</h3>
